...
If ENCRYPT_TYPE = "BMP" Then
        frmTrade.picItems.Picture = LoadPicture(App.Path & "\GFX\items.bmp")
        Else
        ...
        frmTrade.picItems.Cls
        frmTrade.picItems.Width = BMU.ImageWidth
        frmTrade.picItems.Height = BMU.ImageHeight
        Call BMU.Blt(frmTrade.picItems.hDC)
        End If
...
Trade(7).Selected = YES
    
    shopType.Left = Label7.Left
    shopType.Height = Label7.Height
    shopType.Width = Label7.Width
    Trade(7).SelectedItem = 1
    Call ItemSelected(1, 7)
End Sub
