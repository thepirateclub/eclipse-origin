...
Begin VB.Form frmStable 
   ...
   Begin VB.CommandButton CmdMail 
      Height          =   375
      Left            =   360
      Picture         =   "frmMirage.frx":E05E
      Style           =   1  'Graphical
      TabIndex        =   142
      Top             =   8400
      Width           =   1350
   End
   Begin VB.ComboBox MapChat 
      Height          =   315
      ItemData        =   "frmMirage.frx":11CF7
      Left            =   2400
      List            =   "frmMirage.frx":11D07
      Sorted          =   -1  'True
...
Private Sub CmdMail_Click()
    If frmInbox.Visible = False Then frmInbox.Visible = True
End Sub
...
Private Sub Form_KeyUp(KeyCode As Integer, Shift As Integer)
    ...
    If KeyCode = vbKeyF4 Then
        If Player(MyIndex).Access <> 0 Then
            frmGuild.Show vbModeless, frmStable
        End If
    End If
    ...
    If KeyCode = vbKeyF11 Then
        ScreenShot.Picture = CaptureForm(frmStable)
    ...
    If KeyCode = vbKeyF12 Then
        ScreenShot.Picture = CaptureArea(frmStable, picScreen.Left, picScreen.top, picScreen.Width, picScreen.Height)
...
Private Sub picOptions_MouseMove(Button As Integer, Shift As Integer, X As Single, Y As Single)
    Call MovePicture(frmStable.picOptions, Button, Shift, X, Y)
End Sub
...
Private Sub picScreen_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
    ...
    If (Button = 1 Or Button = 2) And InHouseEditor Then
        Call HouseEditorMouseDown(Button, Shift, CurX, CurY)
    End If
    ...
    If Button = 2 And Not InEditor Then
        Call PlayerSearch2(Button, Shift, CurX, CurY)
    End If
